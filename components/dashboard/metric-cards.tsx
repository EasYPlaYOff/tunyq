...
import { Activity, Radio, PiggyBank, FileDown } from "lucide-react"
...
export function MetricCards({ onOpenReport }: MetricCardsProps) {
  return (
      ...
      {onOpenReport && (
        <div className="flex justify-end">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-gradient-to-r from-primary/20 to-accent/20 border border-primary/30 text-foreground hover:from-primary/30 hover:to-accent/30 hover:border-primary/50 transition-all duration-300 group"
          >
            <FileDown className="w-4 h-4 text-primary group-hover:scale-110 transition-transform" />
